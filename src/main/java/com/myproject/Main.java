...
// //         String filePath = "C:\\Users\\Thien\\Documents\\Bách Khoa\\242\\LTNC\\Assignment 2\\Initial Code\\src\\resources\\stocks.json";
...
//       String filePath = "C:\\Users\\Thien\\Documents\\Bách Khoa\\242\\LTNC\\Assignment 2\\Initial Code\\src\\resources\\stocks.json";
//       HosePriceFetchLib hoseLib = new HosePriceFetchLib(filePath);
//       List<String> hoseStockCodes = Arrays.asList("VIC", "VNM", "HPG", "MWG");
//       HoseAdapter hoseAdapter = new HoseAdapter(hoseLib, hoseStockCodes);
//       HnxPriceFetchLib hnxLib = new HnxPriceFetchLib(filePath);
//       List<String> hnxStockCodes = Arrays.asList("SHB", "ACB", "PVS");
//       HnxAdapter hnxAdapter = new HnxAdapter(hnxLib, hnxStockCodes);
...
//     //   Stock VICstock = new Stock("VIC", "Vingroup");
//     //   stockFeeder.addStock(VICstock);
//     //   stockFeeder.registerViewer("VIC", new StockAlertView(60000.0, 55000.0));
//     //   stockFeeder.registerViewer("VIC", new StockRealtimePriceView());
//     //   stockFeeder.registerViewer("VIC", new StockTickerView());
//       registerToViewer("VIC", "Vingroup", 60000.0, 55000.0);
//       registerToViewer("VNM", "Vinamilk", 60000.0, 55000.0);
//       registerToViewer("HPG", "Hoa Phat Group", 60000.0, 55000.0);
//       registerToViewer("MWG", "Mobile World Investment Corporation", 60000.0, 55000.0);
//       registerToViewer("SHB", "Saigon Hanoi Commercial Joint Stock Bank", 60000.0, 55000.0);
//       registerToViewer("ACB", "Asia Commercial Joint Stock Bank", 60000.0, 55000.0);
//       registerToViewer("PVS", "Petrovietnam Technical Services Corp", 60000.0, 55000.0);
//       priceFetchManager.start();
...
//    private static void registerToViewer(String stockCode, String stockName, double highThreshold, double lowThreshold) {
//       Stock newStock = new Stock(stockCode, stockName);
//       stockFeeder.addStock(newStock);
//       stockFeeder.registerViewer(stockCode, new StockAlertView(highThreshold, lowThreshold));
